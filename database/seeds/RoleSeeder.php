...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admins')->insert([
            ...
            ['id'=>2, 'name' => 'Linh Nguyen','email' => 'linhnn160295@gmail.com','password'=> Hash::make('123456'), 'phone'=> '1234567890','address'=>'HN', 'role' => 1],
            ['id'=>3, 'name' => 'Admin','email' => 'admin@gmail.com','password'=> Hash::make('123456'), 'phone'=> '1234567890','address'=>'HN', 'role' => 1],
            ['id'=>4, 'name' => 'Interviewer','email' => 'interviewer@gmail.com','password'=> Hash::make('123456'), 'phone'=> '1234567890','address'=>'HN', 'role' => 2],
            ['id'=>5, 'name' => 'BackOffice','email' => 'backoffice@gmail.com','password'=> Hash::make('123456'), 'phone'=> '1234567890','address'=>'HN', 'role' => 3],
        ]);
        ...
        DB::table('sections')->insert([
            ['id'=>1, 'name' => 'Benefits', 'slug' => Str::slug('Benefits'), 'description' => '', 'content' => 
                        '<div class="col-lg-4">
            ...
            ['id'=>2, 'name' => 'Recruitment Flow', 'slug' => Str::slug('Recruitment Flow'), 'description' => '', 'content' => 
                        ...
                        'image' => '', 'map_url' => ''],
            ['id'=>3, 'name' => 'About Us', 'slug' => Str::slug('About Us'), 'description' => '', 'content' => 
            ...
            ['id'=>4, 'name' => 'Visit Us', 'slug' => Str::slug('Visit Us'), 'description' => '', 'content' => '', 'image' => 'https://www.scuti.asia/uploads/6/1/9/4/61941893/3165626_orig.jpg', 'map_url' => '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.962023272904!2d105.76304874986745!3d21.034205492900966!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b947cd6e49%3A0x6a87974c6b44d671!2zNjggUGjhu5EgTmd1eeG7hW4gQ8ahIFRo4bqhY2gsIE3hu7kgxJDDrG5oLCBU4burIExpw6ptLCBIw6AgTuG7mWksIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1598327887854!5m2!1svi!2s" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>'],
        ]);
