...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('evaluates')->insert([
            ...
            ['id'=>2, 'process_id' => 2,'comment' => 'Ứng viên tiềm năng', 'reason' => 'Qua cuộc phỏng vấn với bạn, chúng tôi đánh giá cao kỹ năng và kinh nghiệm của bạn. Chúc mừng bạn đã vượt qua quá trình này.', 'status' => 1, 'created_at' => \Carbon\Carbon::parse('13-06-2020 03:26:49')->format('Y-m-d H:i:s')],
            ['id'=>3, 'process_id' => 3,'comment' => 'Ứng viên tiềm năng', 'reason' => 'Chúng tôi đã xem qua CV của bạn và chúng tôi đánh giá cao kỹ năng và kinh nghiệm của bạn. Chúc mừng bạn đã vượt qua quá trình này.', 'status' => 1, 'created_at' => \Carbon\Carbon::parse('15-06-2020 03:26:49')->format('Y-m-d H:i:s')],
            ...
            ['id'=>5, 'process_id' => 5,'comment' => 'Ứng viên tiềm năng', 'reason' => 'Chúng tôi đã xem qua CV của bạn và chúng tôi đánh giá cao kỹ năng và kinh nghiệm của bạn. Chúc mừng bạn đã vượt qua quá trình này.', 'status' => 1, 'created_at' => \Carbon\Carbon::parse('05-07-2020 03:26:49')->format('Y-m-d H:i:s')],
            ['id'=>6, 'process_id' => 6,'comment' => 'Ứng viên tiềm năng', 'reason' => 'Qua cuộc phỏng vấn với bạn, chúng tôi đánh giá cao kỹ năng và kinh nghiệm của bạn. Chúc mừng bạn đã vượt qua quá trình này.', 'status' => 1, 'created_at' => \Carbon\Carbon::parse('18-08-2020 03:26:49')->format('Y-m-d H:i:s')],
        ...
        DB::table('events')->insert([
            ...
            ['id'=>2, 'title' => 'Cafe với ứng viên Tâm','user_id' => 1, 'admin_id' => '["1","2"]', 'start' => \Carbon\Carbon::now('Asia/Ho_Chi_Minh'), 'end'=> \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addHour(), 'note'=>'Ứng viên tiềm năng','color'=>'#f5ed0a'],
            ['id'=>3, 'title' => 'Đánh giá ứng viên Linh','user_id' => 2, 'admin_id' => '["1","2","3","4"]', 'start' => \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDay()->addHours(2),'end'=>\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDay()->addHours(3),'note'=>'Ứng viên tiềm năng','color'=>'#f5ee0a'],
            ['id'=>4, 'title' => 'Phỏng vấn ứng viên Tâm','user_id' => 3, 'admin_id' => '["1","2","4"]', 'start' => \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDay()->addHours(3),'end'=>\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDay()->addHours(4),'note'=>'Chuẩn bị demo','color'=>'#191e83'],
            ['id'=>5, 'title' => 'Phỏng vấn ứng viên Linh','user_id' => 2, 'admin_id' => '["1","2","3","4"]', 'start' => \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDays(2)->addHours(4),'end'=>\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDays(2)->addHours(5),'note'=>'Ứng viên tiềm năng','color'=>'#f5ed0a'],
            ['id'=>6, 'title' => 'Phỏng vấn ứng viên User2','user_id' => 3, 'admin_id' => '["1","2","4"]', 'start' => \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDays(2)->addHours(5),'end'=>\Carbon\Carbon::now('Asia/Ho_Chi_Minh')->addDays(2)->addHours(6),'note'=>'Chuẩn bị demo','color'=>'#19xe83'],
        ]);
