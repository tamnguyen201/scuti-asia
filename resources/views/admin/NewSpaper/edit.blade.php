                    ...
                    <form role="form" action="{{route('new_spaper.update', $NewSpaper->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @error('title') has-error @enderror">
                                ...
                                <input type="text" name="title" value="{{$NewSpaper->title}}" class="form-control" placeholder="@lang('custom.placehoder.title')">
                                @error('title') 
                            ...
                            <div class="form-group @error('url') has-error @enderror">
                                ...
                                <input type="text" name="url" value="{{$NewSpaper->url}}" class="form-control" placeholder="@lang('custom.placehoder.url')">
                                @error('url') 
                                <span class="help-block"> {{$message}} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group preview-img">
                                <img src="{{$NewSpaper->image}}" alt="your image" class="img-responsive" />
                            </div>
                        </div>
