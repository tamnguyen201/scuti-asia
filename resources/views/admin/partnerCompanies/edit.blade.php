                ...
                <form role="form" action="{{route('partner_companies.update', $partner->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group @error('name') has-error @enderror">
                            ...
                            <input type="text" name="name" value="{{$partner->name}}" class="form-control" placeholder="Please enter full name">
                            @error('name') 
                        ...
                        <div class="form-group @error('description') has-error @enderror">
                            ...
                            <textarea name="description" cols="30" rows="10" class="form-control" placeholder="Please enter description">{{$partner->description}} </textarea>
                            @error('description') 
                            <span class="help-block"> {{$message}} </span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group preview-img">
                            <img src="{{$partner->logo}}" alt="your image" class="img-responsive" />
                        </div>
                    </div>
