...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Partners Manage</h1>
    </div>
</div>
<div class="col-lg-12">
        ...
        <div class="panel-body">
            <div class="bootstrap-table">
                <div class="fixed-table-toolbar">
                    <a href="{{route('partner_companies.create')}}" class="btn btn-primary" style="float: right"><span class="fa fa-plus"></span> @lang('custom.button.add')</a>
                </div>
