                ...
                <div class="fixed-table-body">
                   ...
                   <table data-toggle="table" data-url="tables/data1.json" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" class="table table-hover">
                      ...
                      <tbody>
                         ...
                         <tr data-index="1">
                            <td class="bs-checkbox"><input data-index="1" name="toolbar1" type="checkbox"></td>
                            <td style="">8</td>
                            <td style="">Item 8</td>
                            <td style="">$8</td>
                         </tr>
                         <tr data-index="2">
                            <td class="bs-checkbox"><input data-index="2" name="toolbar1" type="checkbox"></td>
                            <td style="">7</td>
                            <td style="">Item 7</td>
                            <td style="">$7</td>
                         </tr>
                         <tr data-index="3">
                            <td class="bs-checkbox"><input data-index="3" name="toolbar1" type="checkbox"></td>
                            <td style="">6</td>
                            <td style="">Item 6</td>
                            <td style="">$6</td>
                         </tr>
                         <tr data-index="4">
                            <td class="bs-checkbox"><input data-index="4" name="toolbar1" type="checkbox"></td>
                            <td style="">5</td>
                            <td style="">Item 5</td>
                            <td style="">$5</td>
                         </tr>
                         <tr data-index="5">
                            <td class="bs-checkbox"><input data-index="5" name="toolbar1" type="checkbox"></td>
                            <td style="">4</td>
                            <td style="">Item 4</td>
                            <td style="">$4</td>
                         </tr>
                         <tr data-index="6">
                            <td class="bs-checkbox"><input data-index="6" name="toolbar1" type="checkbox"></td>
                            <td style="">3</td>
                            <td style="">Item 3</td>
                            <td style="">$3</td>
                         </tr>
                         <tr data-index="7">
                            <td class="bs-checkbox"><input data-index="7" name="toolbar1" type="checkbox"></td>
                            <td style="">20</td>
                            <td style="">Item 20</td>
                            <td style="">$20</td>
                         </tr>
                         <tr data-index="8">
                            <td class="bs-checkbox"><input data-index="8" name="toolbar1" type="checkbox"></td>
                            <td style="">2</td>
                            <td style="">Item 2</td>
                            <td style="">$2</td>
                         </tr>
                         <tr data-index="9">
                            <td class="bs-checkbox"><input data-index="9" name="toolbar1" type="checkbox"></td>
                            <td style="">19</td>
                            <td style="">Item 19</td>
                            <td style="">$19</td>
                         </tr>
