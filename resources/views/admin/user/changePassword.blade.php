       ...
       <div class="panel-body">
            <form method="POST" action="{{ route('change.password') }}">
                ...
                <div class="form-group row" style="padding-bottom: 15px">
                    <label for="password" class="col-md-3 col-form-label">@lang('custom.old_pass')* :</label>
                ...
                <div class="form-group row" style="padding-bottom: 15px">
                    <label for="password" class="col-md-3 col-form-label text-md-right">@lang('custom.new_pass')* :</label>
                ...
                <div class="form-group row" style="padding-bottom: 15px">
                    <label for="password" class="col-md-3 col-form-label text-md-right">@lang('custom.confirm_pass')* :</label>
